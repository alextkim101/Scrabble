...
public:
	...
	*/
	...
	void apply(Move* move, Board & board, Bag & bag, Dictionary & dictionary); //[NOTE] NOT SURE WHAT THE CORRECT FUNCTION TYPE IT IS. 
...
public:
	...
	*/
	...
	bool getHorizantal() const { return horiz;} 
	size_t get_x() const { return _x;}
	size_t get_y() const { return _y;} 
	std::string get_string() const { return tile_str;}

private:
	std::vector<Tile*> placingTiles; 
	std::string tile_str;
	bool horiz; 
	size_t _x; 
	size_t _y; 
